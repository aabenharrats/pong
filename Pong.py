...
# Create screen 
sc = turtle.Screen() 
sc.title("Adam and Yaseen's Pong Game") 
sc.bgcolor("black") 
...
sketch.hideturtle() 
sketch.goto(0, 260) 
sketch.write("Yaseen : 0    Adam: 0", align="center", font=("Courier", 24, "normal")) 
...
while True: 
    ...
    if hit_ball.xcor() > 500: 
        ...
        left_player += 1
        sketch.clear()
        sketch.write("Yaseen : {}    Adam: {}".format(left_player, right_player), align="center",  font=("Courier", 24, "normal"))
